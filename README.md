# 🤖 RetroAI - Your Smart Chatbot Companion
...
Welcome to RetroAI! This Python-based smart chatbot can learn, remember, solve math problems, generate QR codes, and respond with voice output. Whether you want a conversation partner or need help with tasks, RetroAI is here for you.

### 🖥️ System Requirements

Before downloading RetroAI, ensure your computer meets the following requirements:
...
RetroAI is packed with several features:

- **Learning Capability**: The chatbot can learn from each interaction.
- **Memory**: It remembers past conversations to improve future interactions.
- **Math Problem Solver**: Input math problems, and RetroAI will solve them for you.
- **QR Code Generation**: Generate QR codes quickly with simple commands.
- **Voice Response**: The integrated text-to-speech feature ensures responses are spoken aloud.
...
Your feedback is important to us. If you have suggestions for improvements or new features, please share your thoughts on the discussion forum. 
